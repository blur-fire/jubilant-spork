...
import pph22Data from '../data/pph22-data.json';

export default function Pph22() {
  const { summary, transactions } = pph22Data;
        ...
        <CardContent className="pt-6">
          ...
          <div className="mb-6 space-y-2">
            <h2 className="text-2xl font-bold text-slate-900">
              PPh 22 Transactions (Barang)
            </h2>
            <p className="text-sm text-slate-600">
              Goods purchases subject to withholding
            </p>
          </div>
